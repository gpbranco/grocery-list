...
import com.branco.grocerylist.cart.ui.SelectedProductFragment;
...
public class MainActivity extends AppCompatActivity implements ProductFragment.ProductsPresenterProvider,
    ...
    private void inject() {
        HomeComponent component = ((GroceryListApp) getApplicationContext())
            .getApplicationComponent()
            .plus(new CartModule(), new ProductsModule(), new HomeModule());
